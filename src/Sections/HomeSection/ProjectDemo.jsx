    ...
    >
      ...
      >
        {projects.map((project) => (
          <div
            key={project.id}
            className={`relative overflow-hidden text-white min-h-[140vh] md:min-h-[70vh] w-screen flex flex-col md:flex-row flex-start md:justify-around items-center`}
          >
            {/* LEFT CONTENT */}
            ...
            {/* CENTER IMAGE */}
            <div className="absolute top-[65%]  md:top-1/2 left-1/2 z-40 -translate-x-1/2 -translate-y-1/2 h-[45%] md:h-[80%] w-[95%] md:w-[35%] overflow-hidden">
              <img
